...
### Hand Gestures
* **1 Finger:** Drawing Mode (Write/Sketch)
* **2 Fingers:** Eraser Mode (Rub out specific areas) / Select Color (Hover)
* **3 Fingers:** Geometric Circle Tool
* **4 Fingers:** Global Clear (Wipe entire board)

### Keyboard Shortcuts
* **G:** Toggle Reference Grid
* **M:** Toggle Virtual Caliper (Measure)
* **B:** Toggle Background Privacy Mask
* **L:** Toggle Laser Pointer (Fading lines)
* **E:** Holographic Eyedropper (Copy Color from real world)
* **Q:** Quit Application
